...
def generate_key(length=10):
    ...
    return f"APNA-VIP-{key.upper()}"  # Ensure key is in uppercase
        ...
        if len(command) == 4:
            ...
            try:
                ...
                if port < 10003 or port > 29999:
                    ...
                    response = "❕𝗠𝗮𝘅𝗶𝗺𝘂𝗺 𝗮𝘁𝘁𝗮𝗰𝗸 𝘁𝗶𝗺𝗲 𝗶𝘀 200 𝘀𝗲𝗰𝗼𝗻𝗱𝘀❕"
                else:
